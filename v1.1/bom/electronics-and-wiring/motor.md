...
internal-specs:
  internal part name: NEMA 17 Stepper Motor (no encoder)
  vendor: Motor - LDO
  cost: $6.00
  notes: "<span style='font-weight: bold; color: red;'>Logo engraving must NOT be stretched.</span> Please send photo of first samples to verify."
---
